...
namespace DragonWar.Utils.Logging
{
    public static class ConsoleColors
    {
        ...
        static Dictionary<byte, ConsoleColor> GameColors = new Dictionary<byte, ConsoleColor>
        {
        ...
        static  Dictionary<byte, ConsoleColor> DatabaseColors = new Dictionary<byte, ConsoleColor>
        {
        ...
        static  Dictionary<byte, ConsoleColor> SocketColors = new Dictionary<byte, ConsoleColor>
        {
        ...
        static  Dictionary<byte, ConsoleColor> EngineColors = new Dictionary<byte, ConsoleColor>
        {
        ...
        static Dictionary<byte, ConsoleColor> CommandColors = new Dictionary<byte, ConsoleColor>
        {
            ...
            { (byte)CommandLogLevel.Console,ConsoleColor.DarkRed },
